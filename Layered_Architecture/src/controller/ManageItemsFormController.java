...
public class ManageItemsFormController {
    ...
    ItemBO itemDAO = (ItemBO) DAOFactory.getDaoFactory().getDAO(DAOFactory.DAOTypes.ITEM);
    ...
    private void loadAllItems() {
        ...
        try {
            ...
            for(ItemDTO itemTM:lt){
                tblItems.getItems().add(new ItemTM(itemTM.getCode(),itemTM.getDescription(),itemTM.getUnitPrice(),itemTM.getQtyOnHand()));
            }
